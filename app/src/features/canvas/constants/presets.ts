...
export const PRESET_DATA: PresetItem[] = [
  // ── 变真实 ──
  {
    ...
    tags: ['照片', '真实', '写实'],
    thumbnail: '/presets/realism/photo-realistic.webp',
  },
  {
    id: 'natural_exposure',
    name: '自然曝光',
    ...
    tags: ['曝光', '光比', '自然'],
    thumbnail: '/presets/realism/natural-exposure.webp',
  },
  {
    ...
    recommendedInCommon: true,
    tags: ['材质', '纹理', '反射'],
    thumbnail: '/presets/realism/material-enhancement.webp',
  },
  {
    ...
    tags: ['玻璃', '反射', '水面'],
    thumbnail: '/presets/realism/realistic-reflection.webp',
  },
  {
    id: 'reduce_ai_feel',
    name: '降低 AI 感',
    ...
    recommendedInCommon: true,
    tags: ['AI感', '自然', '真实'],
    thumbnail: '/presets/realism/reduce-ai-feel.webp',
  },
  {
    ...
    recommendedInCommon: true,
    tags: ['商业', '摄影', '地产'],
    thumbnail: '/presets/realism/commercial-photography.webp',
  },
  {
    ...
    tags: ['植物', '景观', '绿化'],
    thumbnail: '/presets/realism/realistic-vegetation.webp',
  },
  {
    id: 'clear_details',
    name: '细节清晰',
    ...
    tags: ['细节', '清晰', '锐化'],
    thumbnail: '/presets/realism/clear-details.webp',
  },
  // ── 换氛围 ──
  {
    id: 'sunset_mood',
